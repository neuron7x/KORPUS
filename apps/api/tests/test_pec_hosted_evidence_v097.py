...
S="a"*64
def receipt(): return {"provider":"github-actions","run_id":"123","workflow":"pec-production-evidence","release":"v0.9.7","source_digest":S,"local_self_attested":False}
...
def test_hosted_evidence_rejects_local_self_attestation():
    r=receipt(); r["local_self_attested"]=True
