...
build_database_url \
  ...
  RLS_IDENTITY_DATABASE_PASSWORD

unset KORPUS_DATABASE_PASSWORD KORPUS_REVIEW_DATABASE_PASSWORD RLS_IDENTITY_DATABASE_PASSWORD
unset KORPUS_REVIEW_DATABASE_URL_TEMPLATE KORPUS_REVIEW_DATABASE_PASSWORD_FILE
unset RLS_IDENTITY_DATABASE_URL_TEMPLATE RLS_IDENTITY_DATABASE_PASSWORD_FILE
exec "$@"
