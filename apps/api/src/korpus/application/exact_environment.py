...
def exact_environment_state(
    locked: Mapping[str, str], installed: Mapping[str, str], *, python_version: str,
    required_python: str, allowed_unmanaged: Collection[str], hashes_complete: bool,
    ...
    mismatched = {
        ...
        for name, version in locked.items() if installed.get(name) not in {None, version}
    }
