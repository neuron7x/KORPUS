...
def build_in_toto_statement(
    *,
    ...
    return {
        ...
        "predicate": {
            "buildDefinition": {
                "buildType": "https://korpus.dev/build/v1",
                "resolvedDependencies": [{"uri": source_uri, "digest": {"sha256": source_digest}}],
            },
...
def verify_in_toto_subject(
    statement: Mapping[str, object], *, artifact_name: str, artifact_bytes: bytes
) -> bool:
    if (
