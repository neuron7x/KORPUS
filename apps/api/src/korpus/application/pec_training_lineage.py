...
def validate_training_lineage(receipt: Mapping[str, object], *, release: str, profile: str, source_revision: str, dataset_sha256: str) -> TrainingLineageVerdict:
    checks = {
        ...
        "receipt_sha256": len(str(receipt.get("receipt_sha256", ""))) == 64 and all(ch in "0123456789abcdef" for ch in str(receipt.get("receipt_sha256", ""))),
    }
