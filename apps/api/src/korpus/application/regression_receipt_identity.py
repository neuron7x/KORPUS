...
def parse_regression_identity(
    receipt: Mapping[str, object], *, release_tag: str, source_digest: str, collection_digest: str
) -> RegressionReceiptIdentity:
    ...
    return RegressionReceiptIdentity(
        release_tag, source_digest, collection_digest, index, count, nodeids
    )
