...
_FUNCTION_WORDS = frozenset(
    {
        "і", "та", "й", "а", "але", "або", "чи", "що", "як", "це", "цей", "ця", "ці",
        "у", "в", "з", "із", "до", "від", "на", "по", "за", "для", "при", "про", "над",
        "під", "між", "після", "перед", "через", "щодо", "також", "крім", "того",
        "є", "бути", "має", "мають", "слід", "треба", "може", "можна",
        "той", "те", "ті", "його", "її", "їх", "свій", "своя", "своє",
    }
)
