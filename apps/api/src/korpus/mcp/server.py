    ...
    def ask(self, question: str, as_of: str | None = None) -> dict[str, Any]:
        ...
        return {
            ...
            "contract": (
                ...
                "пройшла РІВНО по межі. Це СИМПТОМ, а не правило відмови: виміряно "
                "02.09.2026 на 40 питаннях — ознака стоїть у 3 чужих питаннях із 4, "
                "але й у 2 своїх із 19, і саме тих двох (джгут, евакуація пораненого). "
                "Агент, що відкидає за нею, відмовить на найкритичніших питаннях "
                "корпусу й усе одно пропустить одне чуже."
            ),
        }
