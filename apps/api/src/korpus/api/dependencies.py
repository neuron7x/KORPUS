...
from korpus.answer_composition import build_answer_runtime
...
def get_answer_service(
    ...
    answer_policy, retriever = build_answer_runtime(
        repository, snapshot_reader, cache, semantic_source, settings
    )
