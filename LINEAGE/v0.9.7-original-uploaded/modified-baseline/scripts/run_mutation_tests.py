...
MUTANTS = (
    ...
    Mutant(
        ...
        '    if int(transformed.get("risk_rank", -1)) < int(base.get("risk_rank", -1)):',
        '    if False:',
    ...
    Mutant(
        ...
        '        if not bool(row.get("evidence_unchanged", False)):',
        '        if False:',
    ...
    Mutant(
        ...
        '        0 if bool(row.get("accepted_answer_error")) else 1,',
        '        1 if bool(row.get("accepted_answer_error")) else 0,',
    ...
    Mutant(
        ...
        '        if bool(row.get("model_self_judgment", False)):',
        '        if False:',
