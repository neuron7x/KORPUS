...
# Таблиця синонімів, складена з уяви, виглядає точно як складена з виміру. Гейт
# переміряє її проти корпусу, який обслуговується: запис, чия латинська форма нічого не
# знаходить, — синонім до слова, якого немає.
transliteration-table:
	$(PY) scripts/check_transliteration_table.py --selftest
	$(PY) scripts/check_transliteration_table.py --database "$(or $(DATABASE),$(SERVED_CORPUS))"
