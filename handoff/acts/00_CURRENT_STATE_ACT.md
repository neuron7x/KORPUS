...
- Canonical release: `v6.11.0` readiness-hardening line.
...
- `v6.11.0` changes invalidate those measurements as current-release evidence until fresh gates execute; they remain historical baseline only.
...
Interpretation: `v6.11.0` is a canonical engineering continuation point, not a production authorization. Any agent must regenerate source-bound evidence after changing tracked source and must not reuse `v6.8.2` PASS artifacts as evidence for `v6.11.0`.
