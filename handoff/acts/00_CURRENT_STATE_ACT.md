...
- Canonical release: `v6.14.0` ACT-010 production-evidence orchestration and external-trust boundary line.
...
Interpretation: `v6.14.0` is a canonical engineering continuation point, not a production authorization. Any agent must regenerate source-bound evidence after changing tracked source and must not reuse `v6.8.2` PASS artifacts as evidence for `v6.14.0`.
