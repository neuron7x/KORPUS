...
def evaluate(s: object) -> list[tuple[str, bool, str]]:
    return [
        ...
        (
            ...
            and 'var.database_disk_autoresize_limit_gb >= var.database_disk_size_gb' in s.foundation_vars
            and 'TF_VAR_database_disk_autoresize_limit_gb: ${{ vars.KORPUS_DATABASE_DISK_AUTOSIZE_LIMIT_GB }}' in s.foundation_workflow,
        ...
        (
            "CLOUDSQL_RECOVERY",
            all(token in s.foundation for token in (
