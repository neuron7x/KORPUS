...
def evaluate(s: object) -> list[tuple[str, bool, str]]:
    ...
    return [
        (
            ...
            "python scripts/gcp/validate_terraform_structure.py --output reports/TERRAFORM_STRUCTURE.json" in workflow
            and workflow.find("Validate Terraform structural invariants offline") < workflow.find("Install signature-verified Terraform"),
