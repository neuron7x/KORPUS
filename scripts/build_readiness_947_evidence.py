...
def build(package_evidence_path: Path | None = None) -> dict[str, Any]:
    ...
    dimensions = {
        "product_core": _dimension(criteria=_product_core(context, flags), evidence_class="EXECUTED_WITH_NEGATIVE_CONTROL", **common),
        "architecture_invariants": _dimension(criteria=_architecture(context, flags), evidence_class="EXECUTED_WITH_NEGATIVE_CONTROL", **common),
        "security_internal": _dimension(criteria=_security(context, flags), evidence_class="EXECUTED_WITH_NEGATIVE_CONTROL", **common),
        "tests_tevv": _dimension(criteria=_tests(context, flags), evidence_class="EXECUTED_WITH_NEGATIVE_CONTROL", **common),
        "release_package_integrity": _dimension(criteria=_package(context, flags), evidence_class="EXECUTED_WITH_NEGATIVE_CONTROL", **common),
        "reliability_internal": _dimension(criteria=_reliability(context, flags), evidence_class="EXECUTED_WITH_NEGATIVE_CONTROL", **common),
        "ui_ux": _dimension(criteria=_ui(flags), evidence_class="EXECUTED_WITH_NEGATIVE_CONTROL", **common),
        "maintainability_reproducibility": _dimension(criteria=_maintainability(context, flags), evidence_class="EXECUTED", **common),
    }
    return {
