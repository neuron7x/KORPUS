...
def _gitlab_import_matches() -> bool:
    ...
    return RELEASE_TAG in text and DISTRIBUTION_ARTIFACT in text and ".bundle" not in text
...
def main() -> int:
    ...
    checks = {
        ...
        .startswith(prefix),
        "distribution_contract": (ROOT / "DISTRIBUTION_CONTENTS.md")
        .read_text(encoding="utf-8")
        .startswith(prefix),
        "package_description": (ROOT / "WHAT_IS_IN_THIS_PACKAGE.md")
        .read_text(encoding="utf-8")
        .startswith(prefix),
